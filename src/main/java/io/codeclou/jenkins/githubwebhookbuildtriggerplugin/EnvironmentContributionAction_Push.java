 ...
 */
public class EnvironmentContributionAction_Push implements EnvironmentContributingAction {

    private transient Map<String, String> environmentVariables = new HashMap<>();
    private transient String envVarInfo;

    public EnvironmentContributionAction_Push(GithubWebhookPayload_Push payload) {
        ...
        info.append("   webhook\n      -> $GWBT_TRIGGER            : ").append("push").append("\n");
        ...
        this.environmentVariables.put("GWBT_TRIGGER", "push");
    ...
    public String getDisplayName() {
        return "EnvironmentContributionAction_Push";
    }
